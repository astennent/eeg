...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'eeg_datapoint', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('wave', self.gf('django.db.models.fields.PositiveIntegerField')()),
        ...
        db.send_create_signal(u'eeg', ['DataPoint'])


    def backwards(self, orm):
        # Deleting model 'DataPoint'
        db.delete_table(u'eeg_datapoint')
    ...
    models = {
        ...
        u'eeg.datapoint': {
            ...
            'wave': ('django.db.models.fields.PositiveIntegerField', [], {})
        }
    }
