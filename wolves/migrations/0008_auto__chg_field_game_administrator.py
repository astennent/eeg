...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Game.administrator'
        db.alter_column(u'wolves_game', 'administrator_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['wolves.Account']))

    def backwards(self, orm):

        # Changing field 'Game.administrator'
        db.alter_column(u'wolves_game', 'administrator_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['auth.User']))
