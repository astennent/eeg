...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Player.latitude'
        db.delete_column(u'wolves_player', 'latitude')

        # Deleting field 'Player.longitude'
        db.delete_column(u'wolves_player', 'longitude')

        # Adding field 'Account.latitude'
        db.add_column(u'wolves_account', 'latitude',
                      self.gf('django.db.models.fields.FloatField')(default=0.0),
                      keep_default=False)

        # Adding field 'Account.longitude'
        db.add_column(u'wolves_account', 'longitude',
                      self.gf('django.db.models.fields.FloatField')(default=0.0),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Player.latitude'
        db.add_column(u'wolves_player', 'latitude',
                      self.gf('django.db.models.fields.FloatField')(default=0.0),
                      keep_default=False)

        # Adding field 'Player.longitude'
        db.add_column(u'wolves_player', 'longitude',
                      self.gf('django.db.models.fields.FloatField')(default=0.0),
                      keep_default=False)

        # Deleting field 'Account.latitude'
        db.delete_column(u'wolves_account', 'latitude')

        # Deleting field 'Account.longitude'
        db.delete_column(u'wolves_account', 'longitude')
