...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'wolves_userbadge', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['wolves.Player'])),
            ('badge', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['wolves.Badge'])),
            ('earned', self.gf('django.db.models.fields.DateField')(auto_now_add=True, blank=True)),
        ))
        db.send_create_signal(u'wolves', ['UserBadge'])

        # Adding unique constraint on 'UserBadge', fields ['user', 'badge']
        db.create_unique(u'wolves_userbadge', ['user_id', 'badge_id'])

        # Adding field 'Badge.tag'
        db.add_column(u'wolves_badge', 'tag',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=1, unique=True),
                      keep_default=False)

        # Adding field 'Game.public'
        db.add_column(u'wolves_game', 'public',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)


    def backwards(self, orm):
        # Removing unique constraint on 'UserBadge', fields ['user', 'badge']
        db.delete_unique(u'wolves_userbadge', ['user_id', 'badge_id'])

        # Deleting model 'UserBadge'
        db.delete_table(u'wolves_userbadge')

        # Deleting field 'Badge.tag'
        db.delete_column(u'wolves_badge', 'tag')

        # Deleting field 'Game.public'
        db.delete_column(u'wolves_game', 'public')
    ...
    models = {
        ...
        u'wolves.userbadge': {
            'Meta': {'unique_together': "(('user', 'badge'),)", 'object_name': 'UserBadge'},
            'badge': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['wolves.Badge']"}),
            'earned': ('django.db.models.fields.DateField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['wolves.Player']"})
        }
    }
